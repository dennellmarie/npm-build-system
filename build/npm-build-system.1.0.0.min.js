!function(e){function t(r){if(n[r])return n[r].exports;var i=n[r]={exports:{},id:r,loaded:!1};return e[r].call(i.exports,i,i.exports,t),i.loaded=!0,i.exports}var n={};return t.m=e,t.c=n,t.p="",t(0)}([function(e,t,n){"use strict";var r=n(1),i=n(2);r(document).ready(function(){i()});var o=[{text:"What color is the sky?",answers:["Blue","Yellow","Red","Up for Debate"],correct:0},{text:"How many woods could a woodchuck chuck?",answers:["8","too many","none","not enough"],correct:1},{text:"Is this real life?",answers:["up for debate","who knows?!","no, we're an experimental project","without a doubt"],correct:2},{text:"Who really is America's sweetheart?",answers:["Julia Roberts","Carmen San Diego","Hillary Clinton","Minnie Mouse"],correct:3}],a=r(".questions-page"),s=r(".question-current"),u=r(".questions-total"),l=r(".question"),c=r(".answers"),f=r(".results-page"),p=r(".score"),d=r(".restart-button"),h=function(){a.hide(),f.show()},g=function(){f.hide(),a.show()},m=function(){p.text(0)},v=function(){var e=parseInt(p.text(),10);p.text(e+1)},y=function(e){var t=o[e];s.text(e),l.text(t.text),c.empty();for(var n=0;n<t.answers.length;n++){var r=t.answers[n];c.append('<li><button type="button">'+r+"</button></li>")}};c.on("click","button",function(){var e=r(this).parent().index(),t=parseInt(s.text(),10),n=o[t];n.correct===e&&v(),t+1<o.length?y(t+1):h()}),d.click(function(){y(0),m(),g()}),r(document).ready(function(){u.text(o.length),y(0)})},function(e,t,n){var r,i;/*!
